...
func IsActive(v bool) predicate.School {
	return predicate.School(sql.FieldEQ(FieldIsActive, v))
}
...
// EmailSuffixesIsNil applies the IsNil predicate on the "email_suffixes" field.
func EmailSuffixesIsNil() predicate.School {
	return predicate.School(sql.FieldIsNull(FieldEmailSuffixes))
}

// EmailSuffixesNotNil applies the NotNil predicate on the "email_suffixes" field.
func EmailSuffixesNotNil() predicate.School {
	return predicate.School(sql.FieldNotNull(FieldEmailSuffixes))
}

// VerificationQuestionsIsNil applies the IsNil predicate on the "verification_questions" field.
func VerificationQuestionsIsNil() predicate.School {
	return predicate.School(sql.FieldIsNull(FieldVerificationQuestions))
}

// VerificationQuestionsNotNil applies the NotNil predicate on the "verification_questions" field.
func VerificationQuestionsNotNil() predicate.School {
	return predicate.School(sql.FieldNotNull(FieldVerificationQuestions))
}

// IsActiveEQ applies the EQ predicate on the "is_active" field.
func IsActiveEQ(v bool) predicate.School {
	return predicate.School(sql.FieldEQ(FieldIsActive, v))
}

// IsActiveNEQ applies the NEQ predicate on the "is_active" field.
func IsActiveNEQ(v bool) predicate.School {
	return predicate.School(sql.FieldNEQ(FieldIsActive, v))
}
...
func HasAwards() predicate.School {
	return predicate.School(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAwardsWith(preds ...predicate.Award) predicate.School {
	return predicate.School(func(s *sql.Selector) {
		step := newAwardsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasVoteItems() predicate.School {
	return predicate.School(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasVoteItemsWith(preds ...predicate.VoteItem) predicate.School {
	return predicate.School(func(s *sql.Selector) {
